...
| Section | Description |
|---------|-------------|
| [Tokenomics](Tokenomics) | Token supply, halving schedule, elastic mint, vesting |
| [Proof of Useful Work](Proof-of-Useful-Work) | How mining works, quality scoring |
| [Mainnet Features](Mainnet-Features) | Halving, elastic mint, challenge/slash, time-locked governance |
| [Mining Guide](Mining-Guide) | How to set up and run a miner (multi-backend, HiveOS) |
| [Pool Guide](Pool-Guide) | How to join or run a mining pool |
| [Anti-ASIC](Anti-ASIC) | 5 layers preventing ASIC/FPGA centralization |
| [Stratum Protocol](Stratum-Protocol) | Mining protocol specification |
| [API Reference](API-Reference) | REST API for querying results |
| [Smart Contracts](Smart-Contracts) | On-chain contract details |
| [Data Sources](Data-Sources) | Where the astronomical data comes from |
...
See [Mainnet Features](Mainnet-Features) for full details.
...
For HiveOS, see the [Mining Guide](Mining-Guide#hiveos--docker-deployment).
